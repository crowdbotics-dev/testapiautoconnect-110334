...
## Project Structure
    ...
    ├── testapiautoconnect_110334  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_110334`
...
2. Clone this repo and `cd testapiautoconnect_110334`
